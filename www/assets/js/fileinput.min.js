    ...
    f.prototype = {
        ...
        initPreview: function () {
            ...
            if (c(t) && a > 0) {
                ...
                if (!(a > 0))
                    return n > 0 ? (e.$caption.html(l), void e.$captionContainer.attr("title", l)) : void 0;
        ...
        clear: function (e) {
            ...
            if (e && e.preventDefault(), i.reader instanceof FileReader && i.reader.abort(), i.$element.val(""), i.resetErrors(!0), e !== !1 && (i.$element.trigger("change"), i.$element.trigger("fileclear")), i.overwriteInitial && (i.initialPreviewCount = 0), i.overwriteInitial || d(i.initialPreviewContent)) {
                ...
                i.showFileIcon(), i.$preview.html(i.original.preview), i.$caption.html(i.original.caption), i.$container.removeClass("file-input-new");
        ...
        previewFile: function (e, i, t, a) {
            ...
            if (C && $) {
                if ("text" == l) {
                    ...
                    n = g.replace(/\{previewId\}/g, t).replace(/\{caption\}/g, p).replace(/\{type\}/g, e.type).replace(/\{data\}/g, a).replace(/\{width\}/g, f.width).replace(/\{height\}/g, f.height);
                y.append("\n" + n)
            } else
