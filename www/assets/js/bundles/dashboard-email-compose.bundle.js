webpackJsonp([3], {
    13: function(e, t) {
        $(document).ready(function() {
            "use strict";
            var e, t, n;
            n = $(".mail-item"), e = $("#mail-check-all"), t = $("#email-body"), n.length > 0 && (e.on("change", function() {
                var t;
                t = e.is(":checked"), n.each(function(e, n) {
                    var o, r;
                    n = $(n), o = $('.mail-item-actions input[type="checkbox"]', n), r = o.is(":checked"), t && !r ? o.prop("checked", !0) : !t && r && o.prop("checked", !1)
                })
            }), n.each(function(e, t) {
                var n, o;
                t = $(t), n = t.attr("data-href"), o = $(".mail-item-star", t), o.on("click", function() {
                    t.toggleClass("-starred")
                }), t.on("click", function(e) {
                    var t;
                    t = $(e.target), 0 === t.closest(".mail-item-actions").length && (window.location.href = n)
                })
            })), t.length > 0 && t.summernote({
                callbacks: {
                    onInit: function() {
                        $(".dropdown-menu", t).addClass("-dark")
                    }
                }
            })
        })
